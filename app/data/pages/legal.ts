export const privacyPolicyData = {
  ...
  content: `
    <h2>1. General</h2>
    <p>1.1 The Terms and Conditions defined in this text (hereinafter referred to as "Terms and Conditions") regulate the usage of the games provided through SpinnerTop</p>
    <p>1.2 SpinnerTop is here referred to as "SpinnerTop", "We", "Us" or "Our" and the Player and registered Account Holder shall be referred to as "You", "Yours", "User" or "the Player", as and where appropriate.</p>
    <p>1.3 SpinnerTop reserves the right to modify these Terms and Conditions from time to time for a number of reasons, including to comply with applicable laws and regulations, as well as other regulatory requirements, consequently we may amend this agreement between you and SpinnerTop at any time. The full Terms and Conditions are available on the front page of the Website at all times. It is always recommended to check the Terms and Conditions from time to time to ensure that you agree with them.</p>
    <p>1.4 These Terms and Conditions may be published in a number of languages and shall reflect the same principles. This is done for information purposes and to help players. It is however only the English version that is the legal basis of the relationship between you and SpinnerTop. In case of any discrepancy between the English version and the non-English version of these Terms and Conditions, the English version shall always prevail.</p>

    <h2>2. Intellectual Property</h2>
    <p>2.1 Additionally, you agree not to do anything that will harm or potentially harm the rights, including the intellectual property rights, held by SpinnerTop.</p>
    <p>2.2 You warrant that any names or images used by you in connection with the any site you can visit through our page (for example, your user name) shall not infringe the intellectual property, privacy or other rights of any third party. You hereby grant SpinnerTop a worldwide, irrevocable, transferable, royalty free, sublicensable licence to use such names and images for any purpose connected with the Sites or Service, subject to the terms of our Privacy Policy.</p>
    ...
    <p class="signature">SpinnerTop.com Team</p>
  `
};
...
export const disclaimerData = {
  ...
  content: `
    ...
    <p>Those with any questions regarding the content that is found within the pages of SpinnerTop.com are invited to inquire about it at the email addresses provided. However, SpinnerTop.com maintains no responsibility for customer service issues that are particular to the casino that are reviewed, nor does it serve as a clearinghouse for specific customer complaints. Players are advised to direct contact the gaming establishments using the contact information that has been provided to them.</p>
...
export const termsConditionsData = {
  ...
  content: `
    ...
    <p>Welcome to SpinnerTop! These terms and conditions outline the rules and regulations for the use of SpinnerTop's Website, located at SpinnerTop.com. By accessing this website we assume you accept these terms and conditions. Do not continue to use SpinnerTop if you do not agree to take all of the terms and conditions stated on this page.</p>
...
export const cookiePolicyData = {
  ...
  content: `
    <h2>Cookie Policy</h2>
    <p>We employ the use of cookies. By accessing SpinnerTop, you agreed to use cookies in agreement with the SpinnerTop's Privacy Policy.</p>
